...
import { Args, Mutation, ResolveField, Parent, Resolver, Query, Subscription } from '@nestjs/graphql';
...
export class RecipesResolver {
  ...
  recipes(@Args() recipesArgs: RecipesArgs): Promise<IRecipe[]> {
    return this.recipesService.findAll(recipesArgs);
  }

  @Mutation((returns) => IRecipe)
  async addRecipe(
